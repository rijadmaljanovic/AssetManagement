<template>
    ...
    <div class="card-table mb-4 card">
        <div class="card-header">
            <h4 class="card-heading">List of all Product Types</h4>
        </div>
                ...
                <thead>
                    <tr>
                        <th data-sortable class>
                            <a href="#" class="dataTable-sorter">Product type name</a>
                        </th>
                    </tr>
                </thead>
                <tbody>
...
export default {
    ...
    methods: {
        ...
        getProductTypes() {
            axios.get('https://internship2021-api.mss.ba/api/Reports/productTypes')
