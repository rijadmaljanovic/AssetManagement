<template>
    ...
    <div class="card-table mb-4 card">
        <div class="card-header">
            <h4 class="card-heading">List of all Assets</h4>
        </div>
            ...
            <table class="table mb-0 table-hover align-middle table-borderless dataTable-table">
                <thead>
                    <tr>
                        ...
                        <th data-sortable class>
                            <a href="#" class="dataTable-sorter">Serial number</a>
                        </th>
                        <th data-sortable class>
                         ...
                         <th data-sortable class>
                            <a href="#" class="dataTable-sorter">Purchase Date</a>
                        </th>
                         <th data-sortable class="asc">
...
export default {
    ...
    methods: {
        getAssets() {
            axios.get('https://internship2021-api.mss.ba/api/Reports/assets')
